...
var useLegacyControllers = require('./formulas/use-legacy-controllers');
...
EmberWatson.prototype.useLegacyControllers = function(path) {
  var files = findFiles(path, '.js');
  transform(files, this._useLegacyControllers);
};

EmberWatson.prototype._useLegacyControllers = useLegacyControllers;
